...
public class SelectionTool implements Tool
{
	...
	public void moveTo(int x, int y) 
	{
		...
		// Nótese que no se crea una acción porque estos movimientos intermedios no hay
		// que deshacerlos, sino todo de una vez (desde que se pulsa la primera vez hasta
