...
public class Drawing 
{
	 ...
	 * 
	 * Este método también limpia la selección anterior que hubiera y hace que la
	 * nueva figura recién añadida pase a estar seleccionada.
	 * 
	...
	/**
	 * Elimina la figura especificada del documento de dibujo. La figura debe ser
	 * una referencia válida (no nula) a una de las figuras realmente contenidas
	 * en este documento; en caso de no ser así se lanzará una excepción.
	 * 
	 * @param figure la figura a eliminar de este document
	 * @throws IllegalArgumentException si se trata de borrar una figura nula o
	 *                                  que no pertenece a este documento de dibujo
	 */
